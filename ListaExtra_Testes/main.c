...
/**Aqui eu percebi que o embaralhamento era somente a troca de uma coluna
por outra e de uma linha por outra...pra isso eu fiz a troca da linha 0
pela 2 e a coluna 0 pela 2...O detalhe está no fato de eu precisar fazer
duas trocas, logo N/2, assim eu posso fazer para qualquer matriz n x n **/
//Troca da linha
 int aux = 0;
 for(int i=0; i<2; i++){
 for(int j=0; j<N; j++){
...
//=========================ETAPA 04===============================
// o desembaralhamento é realizar a troca novamente, assim teremos a
//matriz triangularida novamente, como pede a questão. 
